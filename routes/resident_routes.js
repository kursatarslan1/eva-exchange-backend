...
router.get(
  ...
  residentController.GetAllWaitingApprovalResidents
);
router.get(
  "/getInformationByUnitId",
  residentController.getInformationByUnitId
);
router.get(
  "/getInformationByResidentId",
  residentController.getInformationByResidentId
);
router.put("/approveResident", residentController.ApproveResident);
router.put("/rejectResident", residentController.RejectResident);
router.put("/changePassword", residentController.changePassword);
